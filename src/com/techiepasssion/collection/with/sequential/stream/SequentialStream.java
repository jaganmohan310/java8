package com.techiepasssion.collection.with.sequential.stream;
...
public class SequentialStream {
	...
	public static void displayUsers(List<User> userList,Predicate<User> predicate){
		userList.stream().filter(predicate).forEach(user -> System.out.println(UserInterface.getUserInfo(user)));
	}
}
